...
export type Asset = Node & {
  ...
  seoImage: Array<Seo>;
  coverImageHeroPost: Array<HeroPost>;
...
/** Asset system model */
export type AssetCoverImageHeroPostArgs = {
  where?: Maybe<HeroPostWhereInput>;
  orderBy?: Maybe<HeroPostOrderByInput>;
  skip?: Maybe<Scalars['Int']>;
  after?: Maybe<Scalars['String']>;
  before?: Maybe<Scalars['String']>;
  first?: Maybe<Scalars['Int']>;
...
export type AssetCreateInput = {
  ...
  coverImageHeroPost?: Maybe<HeroPostCreateManyInlineInput>;
...
export type AssetManyWhereInput = {
  ...
  coverImageHeroPost_every?: Maybe<HeroPostWhereInput>;
  coverImageHeroPost_some?: Maybe<HeroPostWhereInput>;
  coverImageHeroPost_none?: Maybe<HeroPostWhereInput>;
};
...
export type AssetUpdateInput = {
  ...
  coverImageHeroPost?: Maybe<HeroPostUpdateManyInlineInput>;
...
export type HeroPost = Node & {
  __typename?: 'HeroPost';
  /** System stage field */
  stage: Stage;
  /** Get the document in other stages */
  documentInStages: Array<HeroPost>;
  /** The unique identifier */
  id: Scalars['ID'];
  /** The time the document was created */
  createdAt: Scalars['DateTime'];
  ...
  seo?: Maybe<Seo>;
  /** List of HeroPost versions */
  history: Array<Version>;
};


export type HeroPostDocumentInStagesArgs = {
  stages?: Array<Stage>;
  includeCurrent?: Scalars['Boolean'];
  inheritLocale?: Scalars['Boolean'];
};
...
export type HeroPostCoverImageArgs = {
  locales?: Maybe<Array<Locale>>;
};


export type HeroPostSeoArgs = {
  locales?: Maybe<Array<Locale>>;
};


export type HeroPostHistoryArgs = {
  limit?: Scalars['Int'];
  skip?: Scalars['Int'];
  stageOverride?: Maybe<Stage>;
};

export type HeroPostConnectInput = {
  /** Document to connect */
  where: HeroPostWhereUniqueInput;
  /** Allow to specify document position in list of connected documents, will default to appending at end of list */
  position?: Maybe<ConnectPositionInput>;
};

/** A connection to a list of items. */
export type HeroPostConnection = {
  __typename?: 'HeroPostConnection';
  /** Information to aid in pagination. */
  pageInfo: PageInfo;
  /** A list of edges. */
  edges: Array<HeroPostEdge>;
  aggregate: Aggregate;
};

export type HeroPostCreateInput = {
  createdAt?: Maybe<Scalars['DateTime']>;
  updatedAt?: Maybe<Scalars['DateTime']>;
  slug?: Maybe<Scalars['String']>;
  title?: Maybe<Scalars['String']>;
...
export type HeroPostCreateManyInlineInput = {
  /** Create and connect multiple existing HeroPost documents */
  create?: Maybe<Array<HeroPostCreateInput>>;
  /** Connect multiple existing HeroPost documents */
  connect?: Maybe<Array<HeroPostWhereUniqueInput>>;
};

export type HeroPostCreateOneInlineInput = {
  /** Create and connect one HeroPost document */
  create?: Maybe<HeroPostCreateInput>;
  /** Connect one existing HeroPost document */
  connect?: Maybe<HeroPostWhereUniqueInput>;
};

/** An edge in a connection. */
export type HeroPostEdge = {
  __typename?: 'HeroPostEdge';
  /** The item at the end of the edge. */
  node: HeroPost;
  /** A cursor for use in pagination. */
  cursor: Scalars['String'];
...
/** Identifies documents */
export type HeroPostManyWhereInput = {
  /** Contains search across all appropriate fields. */
  _search?: Maybe<Scalars['String']>;
  /** Logical AND on all given filters. */
  AND?: Maybe<Array<HeroPostWhereInput>>;
  /** Logical OR on all given filters. */
  OR?: Maybe<Array<HeroPostWhereInput>>;
  /** Logical NOT on all given filters combined by AND. */
  NOT?: Maybe<Array<HeroPostWhereInput>>;
  id?: Maybe<Scalars['ID']>;
  /** All values that are not equal to given value. */
  id_not?: Maybe<Scalars['ID']>;
  /** All values that are contained in given list. */
...
export enum HeroPostOrderByInput {
  IdAsc = 'id_ASC',
  IdDesc = 'id_DESC',
  CreatedAtAsc = 'createdAt_ASC',
  CreatedAtDesc = 'createdAt_DESC',
...
export type HeroPostUpdateInput = {
  slug?: Maybe<Scalars['String']>;
  title?: Maybe<Scalars['String']>;
  date?: Maybe<Scalars['String']>;
...
export type HeroPostUpdateManyInlineInput = {
  /** Create and connect multiple HeroPost documents */
  create?: Maybe<Array<HeroPostCreateInput>>;
  /** Connect multiple existing HeroPost documents */
  connect?: Maybe<Array<HeroPostConnectInput>>;
  /** Override currently-connected documents with multiple existing HeroPost documents */
  set?: Maybe<Array<HeroPostWhereUniqueInput>>;
  /** Update multiple HeroPost documents */
  update?: Maybe<Array<HeroPostUpdateWithNestedWhereUniqueInput>>;
  /** Upsert multiple HeroPost documents */
  upsert?: Maybe<Array<HeroPostUpsertWithNestedWhereUniqueInput>>;
  /** Disconnect multiple HeroPost documents */
  disconnect?: Maybe<Array<HeroPostWhereUniqueInput>>;
  /** Delete multiple HeroPost documents */
  delete?: Maybe<Array<HeroPostWhereUniqueInput>>;
};

export type HeroPostUpdateManyInput = {
  title?: Maybe<Scalars['String']>;
  date?: Maybe<Scalars['String']>;
  excerpt?: Maybe<Scalars['String']>;
  content?: Maybe<Scalars['RichTextAST']>;
...
export type HeroPostUpdateManyWithNestedWhereInput = {
  /** Document search */
  where: HeroPostWhereInput;
  /** Update many input */
  data: HeroPostUpdateManyInput;
};

export type HeroPostUpdateOneInlineInput = {
  /** Create and connect one HeroPost document */
  create?: Maybe<HeroPostCreateInput>;
  /** Update single HeroPost document */
  update?: Maybe<HeroPostUpdateWithNestedWhereUniqueInput>;
  /** Upsert single HeroPost document */
  upsert?: Maybe<HeroPostUpsertWithNestedWhereUniqueInput>;
  /** Connect existing HeroPost document */
  connect?: Maybe<HeroPostWhereUniqueInput>;
  /** Disconnect currently connected HeroPost document */
  disconnect?: Maybe<Scalars['Boolean']>;
  /** Delete currently connected HeroPost document */
  delete?: Maybe<Scalars['Boolean']>;
};

export type HeroPostUpdateWithNestedWhereUniqueInput = {
  /** Unique document search */
  where: HeroPostWhereUniqueInput;
  /** Document to update */
  data: HeroPostUpdateInput;
};

export type HeroPostUpsertInput = {
  /** Create document if it didn't exist */
  create: HeroPostCreateInput;
  /** Update document if it exists */
  update: HeroPostUpdateInput;
};

export type HeroPostUpsertWithNestedWhereUniqueInput = {
  /** Unique document search */
  where: HeroPostWhereUniqueInput;
  /** Upsert data */
  data: HeroPostUpsertInput;
};

/** Identifies documents */
export type HeroPostWhereInput = {
  /** Contains search across all appropriate fields. */
  _search?: Maybe<Scalars['String']>;
  /** Logical AND on all given filters. */
  AND?: Maybe<Array<HeroPostWhereInput>>;
...
/** References HeroPost record uniquely */
export type HeroPostWhereUniqueInput = {
  id?: Maybe<Scalars['ID']>;
  slug?: Maybe<Scalars['String']>;
};
...
export type Mutation = {
  ...
  /** Create one heroPost */
  createHeroPost?: Maybe<HeroPost>;
  /** Update one heroPost */
  updateHeroPost?: Maybe<HeroPost>;
  /** Delete one heroPost from _all_ existing stages. Returns deleted document. */
  deleteHeroPost?: Maybe<HeroPost>;
  /** Upsert one heroPost */
  upsertHeroPost?: Maybe<HeroPost>;
  /** Publish one heroPost */
  publishHeroPost?: Maybe<HeroPost>;
  /** Unpublish one heroPost from selected stages. Unpublish either the complete document with its relations, localizations and base data or specific localizations only. */
  unpublishHeroPost?: Maybe<HeroPost>;
  /** Update many HeroPost documents */
  updateManyHeroPostsConnection: HeroPostConnection;
  /** Delete many HeroPost documents, return deleted documents */
  deleteManyHeroPostsConnection: HeroPostConnection;
  /** Publish many HeroPost documents */
  publishManyHeroPostsConnection: HeroPostConnection;
  /** Find many HeroPost documents that match criteria in specified stage and unpublish from target stages */
  unpublishManyHeroPostsConnection: HeroPostConnection;
  /**
   * Update many heroPosts
   * @deprecated Please use the new paginated many mutation (updateManyHeroPostsConnection)
   */
  updateManyHeroPosts: BatchPayload;
  /**
   * Delete many HeroPost documents
   * @deprecated Please use the new paginated many mutation (deleteManyHeroPostsConnection)
   */
  deleteManyHeroPosts: BatchPayload;
  /**
   * Publish many HeroPost documents
   * @deprecated Please use the new paginated many mutation (publishManyHeroPostsConnection)
   */
  publishManyHeroPosts: BatchPayload;
  /**
   * Unpublish many HeroPost documents
   * @deprecated Please use the new paginated many mutation (unpublishManyHeroPostsConnection)
   */
  unpublishManyHeroPosts: BatchPayload;
  /** Create one page */
...
export type MutationCreateHeroPostArgs = {
  data: HeroPostCreateInput;
};


export type MutationUpdateHeroPostArgs = {
  where: HeroPostWhereUniqueInput;
  data: HeroPostUpdateInput;
};


export type MutationDeleteHeroPostArgs = {
  where: HeroPostWhereUniqueInput;
};


export type MutationUpsertHeroPostArgs = {
  where: HeroPostWhereUniqueInput;
  upsert: HeroPostUpsertInput;
};


export type MutationPublishHeroPostArgs = {
  where: HeroPostWhereUniqueInput;
  to?: Array<Stage>;
};


export type MutationUnpublishHeroPostArgs = {
  where: HeroPostWhereUniqueInput;
  from?: Array<Stage>;
};


export type MutationUpdateManyHeroPostsConnectionArgs = {
  where?: Maybe<HeroPostManyWhereInput>;
  data: HeroPostUpdateManyInput;
  skip?: Maybe<Scalars['Int']>;
  first?: Maybe<Scalars['Int']>;
  last?: Maybe<Scalars['Int']>;
...
export type MutationDeleteManyHeroPostsConnectionArgs = {
  where?: Maybe<HeroPostManyWhereInput>;
  skip?: Maybe<Scalars['Int']>;
  first?: Maybe<Scalars['Int']>;
  last?: Maybe<Scalars['Int']>;
...
export type MutationPublishManyHeroPostsConnectionArgs = {
  where?: Maybe<HeroPostManyWhereInput>;
  from?: Maybe<Stage>;
  to?: Array<Stage>;
  skip?: Maybe<Scalars['Int']>;
...
export type MutationUnpublishManyHeroPostsConnectionArgs = {
  where?: Maybe<HeroPostManyWhereInput>;
  stage?: Maybe<Stage>;
  from?: Array<Stage>;
  skip?: Maybe<Scalars['Int']>;
...
export type MutationUpdateManyHeroPostsArgs = {
  where?: Maybe<HeroPostManyWhereInput>;
  data: HeroPostUpdateManyInput;
};


export type MutationDeleteManyHeroPostsArgs = {
  where?: Maybe<HeroPostManyWhereInput>;
};


export type MutationPublishManyHeroPostsArgs = {
  where?: Maybe<HeroPostManyWhereInput>;
  to?: Array<Stage>;
};


export type MutationUnpublishManyHeroPostsArgs = {
  where?: Maybe<HeroPostManyWhereInput>;
  from?: Array<Stage>;
};
...
export type Query = {
  ...
  /** Retrieve multiple heroPosts */
  heroPosts: Array<HeroPost>;
  /** Retrieve a single heroPost */
  heroPost?: Maybe<HeroPost>;
  /** Retrieve multiple heroPosts using the Relay connection interface */
  heroPostsConnection: HeroPostConnection;
  /** Retrieve document version */
  heroPostVersion?: Maybe<DocumentVersion>;
...
export type QueryHeroPostsArgs = {
  where?: Maybe<HeroPostWhereInput>;
  orderBy?: Maybe<HeroPostOrderByInput>;
  skip?: Maybe<Scalars['Int']>;
  after?: Maybe<Scalars['String']>;
...
export type QueryHeroPostsConnectionArgs = {
  where?: Maybe<HeroPostWhereInput>;
  orderBy?: Maybe<HeroPostOrderByInput>;
  skip?: Maybe<Scalars['Int']>;
  after?: Maybe<Scalars['String']>;
...
export type QueryHeroPostVersionArgs = {
  where: VersionWhereInput;
};
...
export type SeoCreateInput = {
  ...
  heroPost?: Maybe<HeroPostCreateOneInlineInput>;
};
...
export type SeoManyWhereInput = {
  ...
  heroPost?: Maybe<HeroPostWhereInput>;
};
...
export type SeoUpdateInput = {
  ...
  heroPost?: Maybe<HeroPostUpdateOneInlineInput>;
};
...
export type GetHomePostsQuery = (
  ...
  & { posts: Array<(
    { __typename?: 'Post' }
    & Pick<Post, 'id' | 'title' | 'excerpt' | 'date' | 'slug'>
    & { coverImage?: Maybe<(
      { __typename?: 'Asset' }
      & Pick<Asset, 'url'>
    )> }
...
export type GetHeroPostQueryVariables = Exact<{ [key: string]: never; }>;


export type GetHeroPostQuery = (
  { __typename?: 'Query' }
  & { heroPosts: Array<(
    { __typename?: 'HeroPost' }
    & Pick<HeroPost, 'id' | 'title' | 'excerpt' | 'date' | 'slug'>
    & { coverImage?: Maybe<(
      { __typename?: 'Asset' }
      & Pick<Asset, 'url'>
    )> }
